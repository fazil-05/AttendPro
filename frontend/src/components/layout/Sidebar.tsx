...
const navItems: NavItem[] = [
  ...
  { label: 'Leave Requests', icon: <CalendarDays size={20} />, path: '/leaves', roles: ['super_admin', 'branch_manager'] },
  { label: 'My Leaves', icon: <CalendarDays size={20} />, path: '/my-leaves', roles: ['office_employee', 'field_employee'] },
